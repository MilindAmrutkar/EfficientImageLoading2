package com.onestechsolution.efficientimageloading;
...
public class ImageUriDatabase {
    ...
    public static String getDatabasePath() {
        ...
        if(checkExternalStorage()){
            ...
            File direct = new File(Environment.getDataDirectory() + "/data/com.onestechsolution.efficientimageloading/GBVJewellers/ImageUri");
            if (!direct.exists()) {
                if (direct.mkdir());
            }
